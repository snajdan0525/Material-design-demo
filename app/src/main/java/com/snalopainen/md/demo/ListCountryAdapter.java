...
public class ListCountryAdapter extends BaseAdapter {
    ...
    public ListCountryAdapter(Context context, String[] dataset) {
        mContext = context;
        mDataset = dataset;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.rectangleimage_list_item, parent, false);
